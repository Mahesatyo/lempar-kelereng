    ...
    while True:
        try:
            ...
            if isWin == False:
                ...
                os.system("CLS")
                print("\nPemain-1 Win Count\t: {}".format(winCount[0]))
                print("Pemain-2 Win Count\t: {}".format(winCount[1]))
                print("PERMAINAN SELESAI! Pemenangnya adalah-{}".format(winner))
            ...
            print(f"Pemain-{index + 1} has left the game room!")
            player_total -= 1
            break
...
def game():
    ...
    print("LEMPAR KELERENG DIMULAI!")
    print("Pemain-{} turn\n".format(player_turn))
    print("Pemain-1 Win Count\t: {}".format(winCount[0]))
    print("Pemain-1 Last Roll\t: {}\n".format(tempRoll[0]))
    print("Pemain-2 Win Count\t: {}".format(winCount[1]))
    print("Pemain-2 Last Roll\t: {}\n".format(tempRoll[1]))
